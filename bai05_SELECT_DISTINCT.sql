...
FROM Suppliers;
GO
-- Ví dụ 03: Viết câu lệnh SQl lấy ra các dữ liệu khác nhau về họ (LastName) và chức danh lịch sự (TitleOfCourtesy) của các nhân viên từ bảng "Employees".
...
GO
-- C. Thử thách. --
-- Thử thách 1: Viết câu lệnh SQL lấy ra các mã danh mục/thể loại (CategoryID) khác nhau của các sản phẩm từ bảng "Products". 
SELECT DISTINCT CategoryID
FROM Products;
GO
-- Thử thách 2: Viết câu lệnh SQL lấy ra số lượng (Quantity) khác nhau từ bảng "Order Details".
